...
<AnimationWrapper className="projectcardhoverheight" style={{display:'flex',alignItems:'center'}}><CardImg   top width="100%" height="99.5%" className="Projectcardimgheight" src={dhahab} style={{borderTopLeftRadius:8,borderTopRightRadius:8}} alt="Card image cap" /></AnimationWrapper>
        <CardText >    
