...
<Container fluid  id="container2" style={{  backgroundImage:`url(${tosee2})`,}}>
          ...
          < img src={profile11}   className="Photosize" />
            ...
            <Row><Col md="8" sm="12"  className="mydetailsstyle ">
...
{/* start here */}
      ...
      <Card md='12' sm="8"  style={{height:230,padding:5,display:'flex',alignItems:'center',justifyContent:'center',borderColor:'transparent',backgroundColor:'transparent'}}>
...
<div className="experiencetextheight" >
    ...
    <AnimationWrapper className="projectcardhoverheight"><CardImg   top width="100%" height="100%" className="Projectcardimgheight" src={logo1}  alt="Card image cap" /></AnimationWrapper>
      ...
      <div className="mob-button" style={{display:'flex',justifyContent:'space-evenly',alignItems:'center',height:77,margin: 0}}>
