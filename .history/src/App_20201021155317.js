...
import dhaab from '../src/assests/dhaab.jpeg';
...
<AnimationWrapper className="projectcardhoverheight"><CardImg   top width="100%" height="100%" className="Projectcardimgheight" src={dhaab} style={{borderTopLeftRadius:28,borderTopRightRadius:28,borderTopColor:'white'}} alt="Card image cap" /></AnimationWrapper>
        <CardText >    
