...
<Col sm="6" md="3">
<Card className="cardproject" style={{backgroundColor:'#246A73',}} >
<AnimationWrapper className="projectcardhoverheight"><CardImg   top width="100%" height="100%" className="Projectcardimgheight" src={dhahab} style={{borderTopLeftRadius:12,borderTopRightRadius:812} alt="Card image cap" /></AnimationWrapper>
        <CardText >    
