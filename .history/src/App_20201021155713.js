...
<AnimationWrapper className="projectcardhoverheight"><CardImg   top width="98%" height="100%" className="Projectcardimgheight" src={dhahab} style={{borderTopLeftRadius:28,borderTopRightRadius:28}} alt="Card image cap" /></AnimationWrapper>
        <CardText >    
