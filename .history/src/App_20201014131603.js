...
{/* <========= HEADER START====================> */}
            ...
            <Link activeClass="active"  spy={true} smooth={true} duration={1000}  className="textheader" >Home</Link>
            <Link activeClass="active"  spy={true} smooth={true} duration={1000}  className="textheader" >About</Link>
            <Link activeClass="active"  spy={true} smooth={true} duration={1000}  className="textheader" >Skills</Link>
            <Link activeClass="active"  spy={true} smooth={true} duration={1000}  className="textheader" >Experience</Link>
            <Link activeClass="active"  spy={true} smooth={true} duration={1000}  className="textheader" >Project</Link>
            <Link activeClass="active"  spy={true} smooth={true} duration={1000}  className="textheader" >Contact</Link>
  </Collapse>
        </Navbar>
