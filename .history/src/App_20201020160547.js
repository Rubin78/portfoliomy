    ...
    <AnimationWrapper className="projectcardhoverheight"><CardImg   top width="100%" height="100%" className="Projectcardimgheight" src={logo1}  alt="Card image cap" /></AnimationWrapper>
        ...
        <div>
          ...
          <AnimationWrapper  >
            ...
            <Tooltip title={<Col sm="6" style={{  fontSize:13,backgroundColor:'ffffff',cursor:'pointer'}}   globalEventOff="touchstart" > title this is the online apllications specially dveloped for womens for online consultations title this is the online apllications specially dveloped for womens for online consultations
