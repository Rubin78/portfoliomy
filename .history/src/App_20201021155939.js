...
<AnimationWrapper className="projectcardhoverheight" style={{display:'flex',alignItems:'center'}}><CardImg   top width="100%" height="99%" className="Projectcardimgheight" src={dhahab} style={{borderTopLeftRadius:28,borderTopRightRadius:28}} alt="Card image cap" /></AnimationWrapper>
        <CardText >    
