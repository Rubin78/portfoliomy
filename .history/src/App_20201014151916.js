...
{/* <========= HEADER START====================> */}
            ...
            <Link activeClass="active" to="container3" spy={true} smooth={true} duration={1000}  className="textheader" >Home</Link>
            ...
            <Link activeClass="active" to="container7" spy={true} smooth={true} duration={1000}  className="textheader" >Contact</Link></Nav>
  </Collapse>
        </Navbar>
