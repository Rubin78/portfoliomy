...
<Col sm="6" md="3">
<Card className="cardproject"  >
<AnimationWrapper className="projectcardhoverheight"><CardImg   top width="98%" height="100%" className="Projectcardimgheight" src={Gymlog} style={{borderTopLeftRadius:8,borderTopRightRadius:8}} alt="Card image cap" /></AnimationWrapper>
        <CardText >    
