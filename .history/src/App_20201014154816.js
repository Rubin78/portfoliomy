...
<div style={{display:'flex',flexWrap:'nowrap',flexFlow:'column'}}>
            ...
            <Link activeClass="active" to="container7" spy={true} smooth={true} duration={1000}  className="textheader" >Contact</Link></div>
  </Collapse>
        </Navbar>
